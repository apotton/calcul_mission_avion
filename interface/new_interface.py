...
frame_Montee.grid(row=0, column=0, columnspan=5)
frame_Croisiere.grid(row=1, column=0, columnspan=6)


tk.Label(frame_Montee, text="Payload :").grid(row=0, column=0, sticky="e")
m_payload = tk.Entry(frame_Montee, width=10)
m_payload.grid(row=0, column=1)
tk.Label(frame_Montee, text="kg").grid(row=0, column=2, sticky="w")

tk.Label(frame_Montee, text="Montée").grid(row=1, column=0, sticky="w")
tk.Label(frame_Montee, text="Altitude initiale :").grid(row=2, column=0, sticky="e")
h_initial_ft = tk.Entry(frame_Montee, width=10)
h_initial_ft.grid(row=2, column=1)
tk.Label(frame_Montee, text="ft").grid(row=2, column=2, sticky="w")
tk.Label(frame_Montee, text="Altitude du pallier :").grid(row=3, column=0, sticky="e")
h_accel_ft = tk.Entry(frame_Montee, width=10)
h_accel_ft.grid(row=3, column=1)
tk.Label(frame_Montee, text="ft").grid(row=3, column=2, sticky="w")
